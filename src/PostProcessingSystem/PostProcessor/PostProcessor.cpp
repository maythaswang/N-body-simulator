...
PostProcessor::PostProcessor(GLfloat screen_w, GLfloat screen_h)
{
...
void PostProcessor::setup_texture(GLuint tex_id)
{
...
void PostProcessor::bind_render_FBO()
{
    glBindFramebuffer(GL_FRAMEBUFFER, this->render_FBO);
...
void PostProcessor::bind_default_FBO()
{
    glBindFramebuffer(GL_FRAMEBUFFER, 0);
    glDisable(GL_DEPTH_TEST);
}

void PostProcessor::resize(GLfloat screen_w, GLfloat screen_h)
{
    this->screen_w = screen_w;
    this->screen_h = screen_h;
...
void PostProcessor::generate_rectangle()
{
...
void PostProcessor::draw_result()
{
    glBindVertexArray(this->rect_VAO);
    // TODO: DRAW
    glBindVertexArray(0);
