...
inline constexpr char g_controls_help[] =
    ...
    "   middle mouse drag + left ctrl   : increase zoom by dragging mouse forward and vice versa.\n"
    "   middle mouse drag               : orbit the camera about the center in the mouse drag direction.\n";
